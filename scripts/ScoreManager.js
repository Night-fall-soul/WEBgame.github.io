class ScoreManager {
    ...
    constructor(dom_renderer) {
        this.dom = dom_renderer; // Référence à l'élément HTML où afficher le score
        this.currentScore = 0;
    ...
    updateDisplay() {
        if (this.dom) {
            this.dom.innerText = `Score: ${this.currentScore} | High: ${this.highScore}`;
        }
    }
